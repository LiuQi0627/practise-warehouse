 ...
 */
@Mapper
public interface OriginOrderInfoTableMapper extends BaseMapper<OrderInfoDO> {
     ...
     */
    List<OrderInfoDO> queryByBatch(@Param("minId") Long minId, @Param("fullDataDeadline") Date fullDataDeadline,
